...
output "export_job_name" {
  ...
  value       = alicloud_sls_oss_export_sink.log_export.job_name
}

output "export_display_name" {
  description = "The display name of the log export job."
  value       = alicloud_sls_oss_export_sink.log_export.display_name
}

output "export_id" {
  description = "The ID of the log export job."
  value       = alicloud_sls_oss_export_sink.log_export.id
}

output "export_status" {
  description = "The status of the log export job."
  value       = alicloud_sls_oss_export_sink.log_export.status
}
